...
.EXAMPLE
    .\create-spec-fixed.ps1 -Type feature -Title "User Authentication"
    .\create-spec-fixed.ps1 -Type api -Title "User API" -Author "John Doe"
    .\create-spec-fixed.ps1 -List
#>
...
class SpecificationCreator {
    ...
    [void]Create([string]$type, [string]$title, [string]$author) {
        ...
        Write-Host "✅ Specification created: $filePath" -ForegroundColor Green
...
if ($List) {
    ...
    Write-Host "Usage: .\create-spec-fixed.ps1 [parameters]"
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\create-spec-fixed.ps1 -Type feature -Title 'User Authentication'"
    Write-Host "  .\create-spec-fixed.ps1 -Type api -Title 'User API' -Author 'John Doe'"
    Write-Host "  .\create-spec-fixed.ps1 -List"
    exit 1
}
