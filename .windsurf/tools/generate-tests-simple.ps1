...
.EXAMPLE
    .\generate-tests-simple.ps1 -Spec "specs\features\SPEC-2026-03-30-001-user-authentication.md"
#>
...
$testContent = New-TestFileInternal -Title $title -SpecId $specId -Type $type -TestCases $testCases -Requirements $requirements
