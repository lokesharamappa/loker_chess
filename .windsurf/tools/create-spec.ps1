...
.EXAMPLE
    .\create-spec.ps1 -Type feature -Title "User Authentication"
    .\create-spec.ps1 -Type api -Title "User API" -Author "John Doe"
    .\create-spec.ps1 -List
#>
...
if ($List) {
    ...
    Write-Host "Usage: .\create-spec.ps1 [parameters]"
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\create-spec.ps1 -Type feature -Title 'User Authentication'"
    Write-Host "  .\create-spec.ps1 -Type api -Title 'User API' -Author 'John Doe'"
    Write-Host "  .\create-spec.ps1 -List"
    exit 1
}
